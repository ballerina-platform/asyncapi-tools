...
public class MapSchemaNegativeTests {
    ...
    public void testForAdditionalPropertiesWithoutParserIssue()
        ...
        AsyncApi25DocumentImpl openAPI = GeneratorUtils.normalizeAsyncAPI(RES_DIR.resolve("swagger" +
                "/additional_properties_true_negative_without_parser_issue.yaml"));
        BallerinaTypesGenerator ballerinaSchemaGenerator = new BallerinaTypesGenerator(openAPI);
        SyntaxTree syntaxTree = ballerinaSchemaGenerator.generateSyntaxTree();
