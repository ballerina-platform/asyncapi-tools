...
//            "   http:BearerTokenConfig|http:CredentialsConfig auth;\n" + commonClientConfigurationFields;
    public static final String WEBSOCKET_CLIENT_CONFIG_PARAM =
            "websocket:ClientConfiguration clientConfig =  {}, string serviceUrl = \"ws://localhost:9090\"";

    public static final String WEBSOCKET_CLIENT_CONFIG_PARAM_NO_URL = "ConnectionConfig config, string serviceUrl";
    public static final String WEBSOCKET_CLIENT_DECLARATION = "websocket:Client websocketEp = check new (serviceUrl," +
            " clientConfig);";
