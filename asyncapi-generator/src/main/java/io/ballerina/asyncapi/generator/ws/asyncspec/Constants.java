...
/**
 * Constants used in the Ballerina WebSocket service to AsyncAPI 3.0.0 conversion.
 */
public class Constants {
    ...
    public static final String ASYNC_API_VERSION = "3.0.0";
    ...
    public static final String CHANNELS_REFERENCE = "#/channels/";
    ...
    public static final String FUNCTION_DEFAULT_NAME_CONTAINS_ERROR = "ERROR: onIdleTimeOut, onMessage, "
            + "onTextMessage, onBinaryMessage, onClose, onOpen, and onError names are not permitted in a "
            + "function's name";
    ...
    public static final String DISPATCHER_STREAM_ID_VALUE_CANNOT_BE_EMPTY = "ERROR: dispatcherStreamId cannot be "
            + "empty";
    ...
    /** JsonNode constant for server-streaming type annotation. */
    public static final JsonNode SERVER_STREAMING_TYPE_NODE = new TextNode(SERVER_STREAMING);
    /** JsonNode constant for close-frame type annotation. */
    public static final JsonNode FRAME_TYPE_CLOSE_NODE = new TextNode(FRAME_TYPE_CLOSE);

    /**
     * Enum to select the Ballerina primitive type for schema generation.
     */
