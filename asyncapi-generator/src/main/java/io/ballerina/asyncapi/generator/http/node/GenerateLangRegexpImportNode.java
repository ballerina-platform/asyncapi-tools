...
/**
 * Generates the {@code import ballerina/lang.regexp;} import declaration node for
 * {@code dispatcher_service.bal}.
 */
public class GenerateLangRegexpImportNode {

    public static final String REGEXP_MODULE = "regexp";
    private static final String BALLERINA_ORG = "ballerina";
    private static final String LANG_MODULE = "lang";

    /**
     * Generates the {@code import ballerina/lang.regexp;} import declaration node.
     *
    ...
    public static ImportDeclarationNode generate() throws GeneratorException {
        return createImportDeclarationNode(
                ...
                createSeparatedNodeList(
                        createIdentifierToken(LANG_MODULE),
                        createToken(DOT_TOKEN),
                        createIdentifierToken(REGEXP_MODULE)),
                null,
