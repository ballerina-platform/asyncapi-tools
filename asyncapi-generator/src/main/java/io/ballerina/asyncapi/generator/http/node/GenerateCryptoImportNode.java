...
/**
 * Generates the {@code import ballerina/crypto;} import declaration node for
 * {@code dispatcher_service.bal}.
 */
public class GenerateCryptoImportNode {

    public static final String CRYPTO_MODULE = "crypto";
    private static final String BALLERINA_ORG = "ballerina";

    /**
     * Generates the {@code import ballerina/crypto;} import declaration node.
     *
    ...
    public static ImportDeclarationNode generate() throws GeneratorException {
        return createImportDeclarationNode(
                ...
                createSeparatedNodeList(createIdentifierToken(CRYPTO_MODULE)),
                null,
