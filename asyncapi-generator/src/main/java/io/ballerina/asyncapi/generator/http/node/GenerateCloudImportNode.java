...
/**
 * Generates the {@code import ballerina/cloud;} import declaration node for {@code listener.bal}.
 *
 * <p>Required because the {@code Listener} class's {@code init()} function marks its listener
 * parameter {@code @cloud:Expose}, matching the convention used across shipped triggers.
 */
public class GenerateCloudImportNode {

    public static final String CLOUD_MODULE = "cloud";
    private static final String BALLERINA_ORG = "ballerina";

    private GenerateCloudImportNode() {
    }

    /**
     * Generates the {@code import ballerina/cloud;} import declaration node.
     *
    ...
    public static ImportDeclarationNode generate() throws GeneratorException {
        return createImportDeclarationNode(
                ...
                createSeparatedNodeList(createIdentifierToken(CLOUD_MODULE)),
                null,
