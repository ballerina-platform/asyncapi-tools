...
public class SchemaDecorator implements Schema {
    ...
    public Object getExtension(String name) {
        return aaiSchema.getExtension(name);
    }

    public SchemaDecorator(AaiSchema aaiSchema) {
    ...
    public String getFormat() {
        return aaiSchema.format;
    }

    @Override
    public void setFormat(String format) {
        aaiSchema.format = format;
    }

    @Override
    public String getTitle() {
        return aaiSchema.title;
    }

    @Override
    public void setTitle(String title) {
        aaiSchema.title = title;
    }

    @Override
    public String getDescription() {
        return aaiSchema.description;
    }

    @Override
    public void setDescription(String description) {
        aaiSchema.description = description;
    }
    ...
    public Number getMultipleOf() {
        return aaiSchema.multipleOf;
    }

    @Override
    public void setMultipleOf(Number multipleOf) {
        aaiSchema.multipleOf = multipleOf;
    }

    @Override
    public Number getMaximum() {
        return aaiSchema.maximum;
    }

    @Override
    public void setMaximum(Number maximum) {
        aaiSchema.maximum = maximum;
    }

    @Override
    public Boolean getExclusiveMaximum() {
        return aaiSchema.exclusiveMaximum;
    }

    @Override
    public void setExclusiveMaximum(Boolean exclusiveMaximum) {
        aaiSchema.exclusiveMaximum = exclusiveMaximum;
    }
    ...
    public Object getItems() {
        if (aaiSchema.items instanceof AaiSchema) {
            ...
            return ((List<AaiSchema>) aaiSchema.items).stream().map(SchemaDecorator::new).collect(Collectors.toList());
        }
        return null;
    }
