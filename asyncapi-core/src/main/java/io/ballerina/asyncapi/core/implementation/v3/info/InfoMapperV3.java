 ...
 * Delegates sub-object mapping to {@link ContactMapperV3}, {@link LicenseMapperV3},
...
public final class InfoMapperV3 {
    ...
    public static AsyncApiInfo map(AsyncApiDocument asyncApiDocument) {
        ...
        return new AsyncApiInfo(
                ...
                ContactMapperV3.map(info.getContact()),
                LicenseMapperV3.map(info.getLicense()),
                tags,
