...
//     */
//    public AsyncApi25DocumentImpl convertServiceToOpenAPI(ServiceDeclarationNode service, AsyncApi25DocumentImpl asyncApi) {
...
//        asyncApi.setChannels(resourceMapper.getChannels(resource));
