 ...
 * {@link io.ballerina.asyncapi.core.model.message.AsyncApiMessageBindings} for AsyncAPI 3.0.
 */
public final class MessageBindingsMapperV3 {

    private MessageBindingsMapperV3() {
    }
    ...
    public static io.ballerina.asyncapi.core.model.message.AsyncApiMessageBindings map(
        ...
        return new io.ballerina.asyncapi.core.model.message.AsyncApiMessageBindings(http, ws, extensions);
    }
