...
public class BallerinaTypesGenerator {
     ...
     */
    public BallerinaTypesGenerator(AsyncApi25DocumentImpl asyncAPI, boolean isNullable,
                                   List<TypeDefinitionNode> typeDefinitionNodeList) {
        GeneratorMetaData.createInstance(asyncAPI, isNullable, false);
     ...
     */
    public BallerinaTypesGenerator(AsyncApi25DocumentImpl asyncAPI, boolean isNullable) {
        this(asyncAPI, isNullable, new LinkedList<>());
    }
    ...
    public BallerinaTypesGenerator(AsyncApi25DocumentImpl asyncAPI) {
        this(asyncAPI, false, new LinkedList<>());
    }
    ...
    public BallerinaTypesGenerator(AsyncApi25DocumentImpl asyncAPI, boolean isNullable,
        ...
        GeneratorMetaData.createInstance(asyncAPI, isNullable, generateServiceType);
        this.typeDefinitionNodeList = typeDefinitionNodeList;
        this.hasConstraints = false;
    }
